jQuery(function($) {
    ...
    var contactNow = '<a class="custom-btn btn-small btn-fixed" href="/" target="_blank" rel="noopener"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Liên Hệ Ngay</a>'
    $('body').append($(contactNow));
